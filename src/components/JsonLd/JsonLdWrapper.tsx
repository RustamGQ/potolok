...
const businessJsonLd = {
  ...
  "description": "Натяжные потолки в Ростове-на-Дону, Батайске, Аксае и области. Бесплатный замер, монтаж за 1 день, гарантия 3 года. Цены от 330₽/м²."
};
...
const faqJsonLd = [
  {
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Базовые цены начинаются от 330₽/м². Точную стоимость рассчитываем при бесплатном замере."
    }
  },
  {
    "@type": "Question",
